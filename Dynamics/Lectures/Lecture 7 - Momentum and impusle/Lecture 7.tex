...
\begin{figure}[h]
  \centering
  \subfloat[Situations]{{\includegraphics[width=50mm]{images/Situations.png}}}%
  \qquad
  \subfloat[Graph]{{\includegraphics[width=50mm]{images/Graph.png}}}%
...
\begin{figure}[h]
  \centering
  \subfloat[Normal]{{\includegraphics[width=50mm]{images/collision_normal.png}}}%
  \qquad
  \subfloat[Rotated]{{\includegraphics[width=50mm]{images/collision_rotated.png}}}%
