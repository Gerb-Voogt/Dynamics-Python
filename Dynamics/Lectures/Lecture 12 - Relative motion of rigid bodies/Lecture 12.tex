...
\begin{figure}[h]
  \centering
  \subfloat[Moving wheel]{{\includegraphics[width=40mm]{images/Wheel_IC.png}}}%
  \qquad \qquad \qquad
  \subfloat[Moving bar]{{\includegraphics[width=40mm]{images/Bar_IC.png}}}%
...
\begin{figure}[h]
  \centering
  \subfloat[absolute frame of reference]{{\includegraphics[width=40mm]{images/Absolute_FOR.png}}}%
  \qquad \qquad \qquad
  \subfloat[frame of reference for $B$ relative to $A$]{{\includegraphics[width=40mm]{images/Relative_FOR.png}}}%
...
\begin{figure}[h]
  \centering
  \subfloat[$\vec{v}_B = \vec{v}_A + \vec{\omega} \times \vec{r}_{B/A}$]{{\includegraphics[width=50mm]{images/Relative_motion.png}}}%
  \qquad \qquad \qquad
  \subfloat[$\vec{v}_B = \vec{v}_A + \vec{\omega} \times \vec{r}_{B/A} + (\vec{v}_{B/A})_{xyz}$]{{\includegraphics[width=50mm]{images/Absolute_motion.png}}}%
